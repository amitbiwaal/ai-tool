...
export async function DELETE(
  ...
  try {
    ...
    // Get review info before deleting (for rating recalculation)
    ...
    // Recalculate tool rating if review was approved
    ...
    console.error("Unexpected error in DELETE review route:", error);
    return NextResponse.json({ 

    ...
    >
      ...
      <Toaster
        ...
        toastOptions={{
          ...
          classNames: {
            toast: "!rounded-2xl !shadow-2xl !border-2 !backdrop-blur-md !ring-1 !ring-black/5 !pl-6 !pr-12 !pt-6 !pb-5 !min-w-[380px] !max-w-[520px] !relative !overflow-hidden",
            title: "!font-semibold !text-base !mb-1 !leading-tight",
            description: "!text-sm !opacity-90 !leading-relaxed",
            closeButton: "!absolute !top-3 !right-3 !w-7 !h-7 !rounded-full !bg-black/10 !hover:bg-black/20 !dark:bg-white/10 !dark:hover:bg-white/20 !flex !items-center !justify-center !transition-all !duration-200 !z-10 !border !border-transparent !hover:border-black/20 !dark:hover:border-white/20",
